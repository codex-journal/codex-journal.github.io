...
alone, but a general law of exchange across substrates.
...
announcement on New Models in July 2024: through pre-print drafts,
through the Becoming Press/CoreCore milieu around it, and through enough
proximity to know both its attraction and its
limits.^\[https://newmodels.substack.com/p/nm81-marek-poliks-on-exocapitalism\]^\[https://becoming.press/dialogues-on-corecore\]
I am extremely reticent about new re-brandings of capitalism, and was
initially pleased to discover that Poliks and Trillo explicitly renounce
the recursive development of the twenty-first-century post-neoliberal
transition problem---although they achieve this by eschewing the idea of
mode of production altogether. Their dismissal of Marx has always read
as jejune and opportunistic to me, although they do not even operate
within such a vocabulary of opportunism, dismissing revolutionary
genealogy altogether. The problem begins with the *exo-* itself: it
recasts capitalism as a transcendental object of Kantian contemplation,
creating an opening for the capitalist sublime to be repositioned and
taken up again in the wake of accelerationism's clear assimilation into
neo-fascism and, in its more mundane presentation, "effective
accelerationism," which, although it had already worn out its welcome,
allowed for the general recuperation of accelerationism into the Silicon
...
room of post-TPOT residue, art-world trend forecasters, and the broader
downtown art-and-technology crowd, with Dena Yago, of the K-Hole /
downtown trend-forecasting milieu, moderating the scheduled softball
Q&A.
...
emerged was instructive: the ontology dissolved on contact with its own
evidence.
...
transitional phase requiring permanent transition management. What gives
the AI bubble its uncanny force is a double bind. If the projected
...
apostasization of merchant capital: money and finance can defer,
...
determining what can be priced and what cannot. The graph has
constitutive opacity---it is never fully legible from the surface---and
that opacity is the condition of arbitrage. The arb comes from entities
that can gain deeper access to the true graph: clearing houses, prime
brokers, sovereign actors, anyone with privileged access to the
counterparty chain. What Poliks and Trillo call "lift" is the
proliferation of new projections over the same graph---each derivative,
SPV, and VPPA exposing a different slice of the underlying obligation
structure and its reducibility conditions---not departure from it.
...
Irony structured the talk's engagement with computation. Every example
Poliks and Trillo presented was a dependency graph---the value chain
diagram they celebrated, the contractual layers of the data center, the
Nvidia-OpenAI-Microsoft loop. Yet their computational model of capital
cannot handle graph analysis, because formalizing dependency structures
would immediately reintroduce everything they need to suppress:
chokepoints, fragility, bio-social terminal nodes. They built a
dependency map and declared the thing independent.
...
world of use-values became partially legible to the world of money. Call
this the transductive subject: the human coordinating center through
...
while remaining theoretically invisible. Exocapitalism cannot pose this
properly because it reduces the state to weak administration while
displacing decisive sovereignty into empire and feudal residues. Finance
does not leave social reproduction behind; it sits atop the monetary
order as its densest recursive layer, binding claims on future cash to
labor, production, and reproduction through the juridical machinery of
