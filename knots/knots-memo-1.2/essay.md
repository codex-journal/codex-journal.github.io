...
direction [@jamesNotesOnDialectics1948]. Knots was closer to the problem
than files, nodes, or blocks because the system needed to preserve those
local stabilizations of meaning, reference, and revision.
