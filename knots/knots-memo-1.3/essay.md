...
rewrote, recombined, and folded them back into the draft. The aim was to
keep iterating until the prose broke the slop barrier; some lines were
still written or finished by hand where cadence, compression, or
conceptual alignment mattered too much to leave to stochastic fluency.
...
also made Haskell a plausible implementation language for knots, because
the problem already looked typed and compiler-shaped.
